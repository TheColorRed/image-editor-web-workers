 ...
 */
export function hslToRgb(h: number, s: number, l: number): [red: number, green: number, blue: number] {
  var r, g, b;
 ...
 */
export function rgbToHsv(r: number, g: number, b: number): [hue: number, saturation: number, value: number] {
  r /= 255, g /= 255, b /= 255;
